...
export class Button extends Component {
  ...
  render = () => {
    ...
    let pending = <i className="fa fa-circle-o-notch fa-spin fa-lg fa-fw" />;
    ...
    return (
      <Link
        ...
        className={`button ${this.getSize()} ${hasPrimary} ${hasSuccess} ${hasWarning} ${hasError} ${hasInfo} ${hasBlock} ${hasWide}`}
      >
        {this.props.pending ? pending : this.props.children}
      </Link>
    );
  };
}
